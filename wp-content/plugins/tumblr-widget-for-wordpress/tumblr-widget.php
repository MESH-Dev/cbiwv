...
function widget( $args, $instance ) {
	...
	// PHOTO POSTS
						if ( $type == "photo" && $show_photo ) {
							...
							echo '<a href="'. ($images_link_to_tumblr_post ? $post_url : $link_url) .'"><div class="tumblr_photo"><img src="'.$url.'" alt="photo from Tumblr" class="portrait" /></div></a>'; // tk
							echo '</li>';
							$post_count++;
						}
