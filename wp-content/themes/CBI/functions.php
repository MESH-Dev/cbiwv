...
function loadup_scripts() {
  ...
  wp_enqueue_script('slider', get_template_directory_uri() . '/assets/libs/responsiveSlides.js', array(), false, true );
	wp_enqueue_script('parallax', get_template_directory_uri() . '/assets/js/jquery.parallax-1.1.3.js', array('jquery'), '1.0.2', true);
...
function get_breadcrumb() {
    ...
    if($post->post_parent) {
        ...
        return $trail;
         ...
         $trail .= '<a href="' . get_permalink($post->ID) . '">' . $page_title . '</a>';
        return $trail;
    }
